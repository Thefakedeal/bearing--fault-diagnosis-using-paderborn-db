...
def load_all_matfiles(channels=None):
    """
    Recursively load all .mat files in dataset and extract features.
    """
    root_dir = "../dataset/paderborn-db"
    all_data = []
